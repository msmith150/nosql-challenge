...
To complete this challenge, I utilized class materials, to include previous exercises/examples, regex101.com, and Xpert Learning Assist/ChatGPT for help with query structure and the pipeline section. 
